...
const HierarchicalCategorySidebar: React.FC<HierarchicalCategorySidebarProps> = ({ 
  products, 
  activeCategory, 
  activeSuperCategory,
  setCategory,
  ...
  const handleSuperCategoryClick = (superCatName: string) => {
    ...
    setCategory('all');
    if (!expandedSuperCategories.has(superCatName)) {
      toggleSuperCategory(superCatName);
    }
  };
            ...
            >
              <div className="flex items-center">
                ...
                <button
                  ...
                  title="Voir tous les produits de cette sur-catégorie"
                >
                  Tout
                </button>
              </div>
...
export default HierarchicalCategorySidebar;
