...
const OrderStatusSection = ({ status, isAdmin, onStatusChange }: OrderStatusSectionProps) => {
  ...
  return (
    <div>
      {isAdmin ? (
        ...
        <Badge className={`${getStatusBadgeClass(status)} text-white flex items-center gap-1`}>
